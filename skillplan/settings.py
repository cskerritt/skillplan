"""
Django settings for SkillPlan project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-1kujrfFG7PVEwukHTTZ1hwH6OKdGxIJ4ILvDeMdq")
...
WSGI_APPLICATION = "skillplan.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="skillplan"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "skillplan_language"
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="skillplan-media")
...
EMAIL_SUBJECT_PREFIX = "[SkillPlan] "
...
ASGI_APPLICATION = "skillplan.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
WAGTAIL_SITE_NAME = "SkillPlan Content"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "skillplan": {
            "handlers": ["console"],
            "level": env("SKILLPLAN_LOG_LEVEL", default="INFO"),
        },
    },
}
